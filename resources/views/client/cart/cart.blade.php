                                ...
                                @if (session()->has('cart'))
                                    @foreach (session('cart') as $value)
                                        @php
                                            $total =
                                                $value['quantities'] *
                                                ($value['price_sale'] ? $value['price_sale'] : $value['price_regular']);
                                        @endphp
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-3">${{ $value['price_sale'] ? number_format($value['price_sale'], 2) : number_format($value['price_regular'], 2) }}
                                            </td>
                                            <td class="column-4">
